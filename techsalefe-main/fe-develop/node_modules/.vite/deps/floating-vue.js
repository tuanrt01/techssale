  ...
  return {
    ...
    async fn(state) {
      ...
      const placementsSortedByMostSpace = allOverflows.map((d2) => {
        ...
        return [d2.placement, alignment2 && crossAxis ? d2.overflows.slice(0, 2).reduce((acc, v) => acc + v, 0) : d2.overflows[0], d2.overflows];
      }).sort((a, b2) => a[1] - b2[1]);
